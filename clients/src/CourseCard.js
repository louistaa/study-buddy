    ...
    <div className="col-sm-12 col-md-6 col-xl-4">
      <div className="card">
        ...
        <div className="registration">
          <button type="button" className="btn btn-outline-primary" onClick={handleStudentRegistration}>Enroll as Student</button>
          <button type="button" className="btn btn-outline-primary" onClick={handleExpertRegistration}>Enroll as Expert</button>  
        </div>
      </div>
    </div> 
  )
