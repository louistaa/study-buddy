...
func (ms *MySQLStore) Delete(classID int64, studentID int64) error {
	del := "delete from StudentCourse where StudentID = ? and CourseID = ?"
	res, err := ms.Database.Exec(del, studentID, classID)
	if err != nil {
		return err
	}
